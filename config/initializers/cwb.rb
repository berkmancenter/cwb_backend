...
# $cwb_database_config     = HashWithIndifferentAccess.new(
#   YAML.load(
#     File.read(
...
#   )
# ) rescue nil
# $cwb_database_query_url  = $cwb_database_config
#                              [Rails.env]['query_endpoint'] rescue nil
# $cwb_database_update_url = $cwb_database_config
#                              [Rails.env]['update_endpoint']
#                                rescue $cwb_database_query_url
