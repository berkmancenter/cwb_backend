  ...
  class Term < CWB::Resource
    ...
    def self.fixtures
      [
        ...
        { id: "Architecture"        , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Audiovisual"         , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Civil"               , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Electrical"          , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "FoodService"         , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Geotechnical"        , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "InfoTech"            , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Interiors"           , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Landscape"           , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Lightning"           , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Mechanical"          , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Plumbing"            , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Security"            , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Signage"             , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Structural"          , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "Unknown"             , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
        { id: "DoesNotApply"        , vocabulary: RDF::URI('http://facade.mit.edu/dataset/ArchitecturalDiscipline') , description: 'null' } ,
